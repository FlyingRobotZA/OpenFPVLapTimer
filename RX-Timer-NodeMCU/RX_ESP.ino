...
static const uint8_t sensorPin[4] = {4, 5, 0, 2}; //eqivalent GPIOs to D1, D2, D3, D4
...
//FPV Race Tracker
const char* openLapSsid = "Burdens - 2.4G";
const char* openLapPassword = "burdens123";
IPAddress openLapHost(192, 168, 0, 255);
